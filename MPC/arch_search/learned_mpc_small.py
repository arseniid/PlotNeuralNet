...
arch = [
    ...
    to_FulCon("fc1", 48, 1, offset="(3,0,0)", to="(bn0-west)", height=1, depth=11, width=1, caption='velocity'),
    to_connection("bn0", "fc1"),
    to_BN("bn1", offset="(1.5,0,0)", to="(fc1-west)", height=1, depth=11, width=1, caption="Id()"),
